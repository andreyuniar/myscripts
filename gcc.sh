...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/andreyuniar/AnyKernel33.git -b master
}
...
gen_zip() {
	...
	mv "$KERNEL_DIR"/out/arch/arm64/boot/Image.gz-dtb AnyKernel33/Image.gz-dtb
	cd AnyKernel33 || exit
